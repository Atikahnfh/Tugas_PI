...
const About = ({children}) => {
  return (
    <section id="about" class="pt-36 pb-32 dark:bg-light">
        <div class="container">
            <div class="flex flex-wrap">
                <div class="w-full px-4 mb-10 lg:w-1/2">
                    <h4 class="font-bold text-bold uppercase text-primary text-lg mb-3">Tentang Kami</h4>
                    <h2 class="font-bold text-dark text-3xl mb-5 max-w-md lg:text-4xl dark:text-dark text-slate-500">Yuk Hunting Beasiswa bersama Scholarfy!</h2>
                ...
                <div class="w-full px-4 lg:w-1/2">
                    <h3 class="font-semibold text-dark text-2xl mb-4 lg:text-3xl lg:pt-10 dark:text-dark text-slate-500">Mari berteman</h3>
                    <p class="font-medium text-base text-secondary mb-6 lg:text-lg">Ayo terhubung dengan scholarfy dan dapatkan informasi terupdate seputar beasiswa!</p>
