        ...
        <div class="container">
            <div class="flex items-center justify-between relative">
                <div required class="px-4">
                    <a href="#home" class="font-bold text-lg text-primary block py-6">API Beasiswa</a>
                </div>
        ...
        <div class="container">
            <div class="flex flex-wrap">
                <div class="w-full px-4 mb-10 lg:w-1/2">
                    ...
                    <h2 class="font-bold text-dark text-3xl mb-5 max-w-md lg:text-4xl dark:text-white">Generate API Token Beasiswa!</h2>
                    <p class="font-medium text-base text-secondary max-w-xl lg:tx-lg">Generate API Token dengan mengisi form yang disediakan agar kamu dapat menggunakan API Beasiswa.</p>
                </div>
