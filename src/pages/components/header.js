                ...
                <div class="flex items-center">
                    ...
                    <nav id="nav-menu" class="hidden absolute py-5 bg-white shadow-lg rounded-lg max-w-[250px] w-full right-4 top-full lg:block lg:static lg:bg-transparent lg:max-w-full lg:shadow-none lg:rounded-none dark:bg-dark lg:dark:bg-transparent dark:shadow-slate-800">
                        <ul class="block lg:flex">
                            ...
                            <li class="group">
                                <Link href="#about" class="text-base py-2 mx-8 flex group-hover:text-primary dark:text-dark">Tentang Kami</Link>
                            </li>
                            <li class="group">
                                <a href="#portfolio" class="text-base py-2 mx-8 flex group-hover:text-primary dark:text-dark">Beasiswa</a>
                            </li>
                            <li class="group">
                                <a href="#clients" class="text-base py-2 mx-8 flex group-hover:text-primary dark:text-dark">Universitas</a>
                            </li>
                            {/* <li class="group">
                                <a href="#blog" class="text-base text-dark py-2 mx-8 flex group-hover:text-primary dark:text-white">Blog</a>
                            </li> */}
                            <li class="group">
                                <a href="#contact" class="text-base py-2 mx-8 flex group-hover:text-primary dark:text-dark">Contact</a>
                            </li>
                            <Link href="/posts/login" class="text-base font-semibold text-white bg-primary py-3 px-4 rounded-lg hover:shadow-lg hover:opacity-80 trasition duration-300 ease-in-out shadow-md">Login</Link>
