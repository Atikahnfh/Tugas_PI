...
<body class="dark:bg-dark">
    ...
    <div id="myAlert" class="fixed top-0 left-0 right-0 bottom-0 flex items-center justify-center">
        <div class="bg-white w-1/3 p-6 rounded-xl shadow-xl border border-slate-200">
            ...
            <p id="alertMessage" class="text-gray-700 mb-10"><?php echo e(session('success')); ?></p>
            ...
            <div class="flex flex-wrap">
                ...
                <div class="w-full px-4 lg:w-1/2">
                    ...
                    <div class="mt-5 sm:max-w-sm">
                        <form class="space-y-6" action="<?php echo e('/generate-token'); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <label for="email">
                                ...
                                <input type="" name="email" id="email" placeholder="Masukkan Email" class="px-3 py-2 border shadow rounded w-full block text-sm placeholder:text-slate-400 focus:outline-none focus:ring-1 focus:ring-primary focus:border-primary dark:shadow-sm dark:shadow-slate-600 <?php $__errorArgs = ['email'];
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <label for="name">
                                ...
                                <input type="text" name="name" id="name" placeholder="Masukkan Nama" class="px-3 py-2 border shadow rounded w-full block text-sm placeholder:text-slate-400 focus:outline-none focus:ring-1 focus:ring-primary focus:border-primary dark:shadow-sm dark:shadow-slate-600 <?php $__errorArgs = ['name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>  ring-pink-700 border-pink-700 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <label for="purpose">
                                ...
                                <textarea name="purpose" id="purpose" placeholder="Tujuan saya untuk..." class="px-3 py-2 border shadow rounded w-full block text-sm placeholder:text-slate-400 focus:outline-none focus:ring-1 focus:ring-primary focus:border-primary dark:shadow-sm dark:shadow-slate-600 <?php $__errorArgs = ['purpose'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>  ring-pink-700 border-pink-700 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('purpose')); ?>"></textarea>
    ...
    <footer class="pt-11 pb-12">
        <div class="container">
            ...
            <div class="w-full pt-5 border-t border-secondary">
                ...
                <p class="font-medium text-xs text-slate-500 text-center">Dibuat dengan <span class="text-pink-500">❤️</span> oleh <a href="https://instagram.com/m.afifanars" target="_blank" class="font-bold text-primary">Kelompok 3</a></p>
            </div>
        </div>
    </footer>
    <!-- Footer End -->
...
</html><?php /**PATH D:\Mhd Afifan Aly Rahman Saragih\Teknologi Informasi '20\TI SM6\Pemorgraman Integrative\Tugas_PI\api-mahasiswa\resources\views/get-token.blade.php ENDPATH**/ ?>