...
<nav class="bg-lime-950">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
      <a href="#" class="flex items-center">
          <img src="<?php echo e(asset('img/logo.png')); ?>" class="h-14 mr-3" alt="Scholars Logo" />
      </a>
...
<div class="box-content ml-56 mt-20 h-72 w-72 border-1 float-left rounded-lg hover:bg-red-300 active:bg-red-600 shadow-lg shadow-black-50">
    <img src="<?php echo e(asset('img/univ.jpg')); ?>" class="h-64 mr-3 rounded-lg object-center hover:object-top " alt="Scholars Logo" />
</div>
<div class="box-content ml-4 mt-20 h-72 w-72 border-1 float-left rounded-lg shadow-lg shadow-gray-50">
  <img src="<?php echo e(asset('img/beasiswa_indo.jpg')); ?>" class="h-64 mr-3 rounded-lg " alt="Scholars Logo" />
</div>
<div class="box-content ml-4 mt-20 h-72 w-72 border-1 float-left rounded-lg shadow-lg shadow-gray-50">
  <img src="<?php echo e(asset('img/beasiswa_ln.jpg')); ?>" class="h-64 mr-3 rounded-lg " alt="Scholars Logo" />
</div>
</body>
</html><?php /**PATH C:\Users\ASUS\Scholars\resources\views/app.blade.php ENDPATH**/ ?>